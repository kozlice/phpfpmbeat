...
"""
This script generates the ES template file (phpfpmbeat.template.json) from
the etc/fields.yml file.

Example usage:

   python scripts/generate_template.py etc/fields.yml etc/phpfpmbeat.template.json
"""
